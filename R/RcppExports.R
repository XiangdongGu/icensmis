...
bayesmc_raw <- function(Dm, Xmat, b, om1, om2, niter, psample, initsurv, nreport, fitsurv) {
    .Call('_icensmis_bayesmc_raw', PACKAGE = 'icensmis', Dm, Xmat, b, om1, om2, niter, psample, initsurv, nreport, fitsurv)
}

bayesmc_pw_raw <- function(Dm, Xmat, breaks, b, om1, om2, niter, psample, initsurv, nreport, fitsurv_pw) {
    .Call('_icensmis_bayesmc_pw_raw', PACKAGE = 'icensmis', Dm, Xmat, breaks, b, om1, om2, niter, psample, initsurv, nreport, fitsurv_pw)
}
